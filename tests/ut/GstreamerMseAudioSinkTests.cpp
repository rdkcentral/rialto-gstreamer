...
// Push Mode tests
TEST_F(GstreamerMseAudioSinkTests, ShouldCreatePushModeSink)
{
...
TEST_F(GstreamerMseAudioSinkTests, ShouldNotReachReadyStateWhenAppStateIsInactiveInPushMode)
{
...
TEST_F(GstreamerMseAudioSinkTests, ShouldFailToAttachSourceInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
...
TEST_F(GstreamerMseAudioSinkTests, ShouldAttachSourceInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldFailToReachPlayingStateInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldReachPlayingStateInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldDelayTransitionToPlayingWhenSourceIsNotAttachedInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldDelayTransitionToPlayingWhenSourceIsNotAttachedAndFailInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldFailToPauseInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldSetEosInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldHandleErrorInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldHandleEosEventInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldHandleUnknownEventInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
...
TEST_F(GstreamerMseAudioSinkTests, ShouldNotifyNewSampleInPushMode)
{
...
TEST_F(GstreamerMseAudioSinkTests, ShouldReturnDefaultVolumeValueWhenPipelineIsBelowPausedStateInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
...
TEST_F(GstreamerMseAudioSinkTests, ShouldGetVolumePropertyInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
    EXPECT_EQ(GST_STATE_CHANGE_SUCCESS, gst_element_set_state(pipeline, GST_STATE_PAUSED));
...
TEST_F(GstreamerMseAudioSinkTests, ShouldFailToSetVolumePropertyWhenPipelineIsBelowPausedStateInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
...
TEST_F(GstreamerMseAudioSinkTests, ShouldSetVolumeInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
    EXPECT_EQ(GST_STATE_CHANGE_SUCCESS, gst_element_set_state(pipeline, GST_STATE_PAUSED));
...
TEST_F(GstreamerMseAudioSinkTests, ShouldFailToSetVolumeInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
    EXPECT_EQ(GST_STATE_CHANGE_SUCCESS, gst_element_set_state(pipeline, GST_STATE_PAUSED));
...
TEST_F(GstreamerMseAudioSinkTests, ShouldSetCachedVolumeInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
...
TEST_F(GstreamerMseAudioSinkTests, ShouldFailToSetCachedVolumeInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
...
TEST_F(GstreamerMseAudioSinkTests, ShouldReturnLastKnownVolumeWhenOperationFailsInPushMode)
{
    RialtoMSEBaseSink *sink{createAudioSinkInWebAudioMode()};
    GstElement *pipeline = createPipelineWithSink(sink);
    EXPECT_EQ(GST_STATE_CHANGE_SUCCESS, gst_element_set_state(pipeline, GST_STATE_PAUSED));
